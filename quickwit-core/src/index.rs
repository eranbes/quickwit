...
impl IndexService {
    ...
    pub async fn get_index(&self, index_id: &str) -> anyhow::Result<IndexMetadata> {
        self.metastore
    ...
    pub async fn create_index(&self, index_config: IndexConfig) -> anyhow::Result<IndexMetadata> {
